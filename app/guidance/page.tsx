          ...
          <main className="mx-auto max-w-3xl space-y-4 p-4 pb-24">
            ...
            <Card title="3. Item buttons">
              <ul className="ml-4 list-disc space-y-1">
                ...
                <li><strong>Low Qty</strong> - enter the current quantity.</li>
                <li><strong>Missing</strong> - item not there; quantity is recorded as 0.</li>
                <li><strong>Expired</strong> - confirm the expired item.</li>
              </ul>
            </Card>
            ...
            <Card title="Tip">
              Start and submit the inspection in one session. Opening the link again starts a fresh
              inspection.
            </Card>
          </main>
          <BottomNav />
